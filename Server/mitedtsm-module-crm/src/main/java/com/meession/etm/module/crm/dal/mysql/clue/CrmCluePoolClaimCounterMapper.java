...
import com.meession.etm.module.crm.dal.dataobject.clue.CrmCluePoolClaimCounterDO;
...
@Mapper
public interface CrmCluePoolClaimCounterMapper extends BaseMapperX<CrmCluePoolClaimCounterDO> {
    ...
    @Update("""
            UPDATE crm_clue_pool_claim_counter
            SET claim_count = claim_count + #{increment}, updater = #{userId}, update_time = NOW()
    ...
    @Insert("""
            INSERT IGNORE INTO crm_clue_pool_claim_counter
