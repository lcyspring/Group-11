...
public class CrmWorkOrderNotificationServiceImpl implements CrmWorkOrderNotificationService {
    ...
    public void notifyAssigned(CrmWorkOrderDO workOrder) {
        send(workOrder.getHandlerUserId(), TEMPLATE_ASSIGNED, workOrder);
    }
    ...
    @Override
    public void notifyCompleted(CrmWorkOrderDO workOrder) {
        send(Long.valueOf(workOrder.getCreator()), TEMPLATE_COMPLETED, workOrder);
    }
