...
@Schema(description = "管理后台 - CRM 营销邮件模板分页 Request VO")
@Data
@EqualsAndHashCode(callSuper = true)
@ToString(callSuper = true)
public class CrmMarketingMailTemplatePageReqVO extends PageParam {

    @Schema(description = "模板名称", example = "促销")
    private String name;

    @Schema(description = "模板编码", example = "PROMOTION_MAIL")
    private String code;
