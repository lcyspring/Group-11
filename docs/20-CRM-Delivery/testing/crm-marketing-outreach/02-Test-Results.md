...
```bash
bash ./podman/build-in-ubuntu.sh ./podman/config/verify-crm-outreach-ubuntu-26.04.yaml
bash ./podman/build-in-ubuntu.sh ./podman/config/verify-crm-outreach-web-ubuntu-26.04.yaml
