...
const toSavePayload = (data: OaEventVO) => ({ ...data, startTime: new Date(toLocalDateTime(data.startTime)).getTime(), endTime: new Date(toLocalDateTime(data.endTime)).getTime() })
export const createOaEvent = (data: OaEventVO) => request.post({ url: '/bpm/oa/event/create', data: toSavePayload(data) })
export const updateOaEvent = (data: OaEventVO) => request.put({ url: '/bpm/oa/event/update', data: toSavePayload(data) })
