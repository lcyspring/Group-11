export default {
  ...
  invoice: {
    managementTitle: 'Invoice Management', detail: 'Invoice Details', applicationNo: 'Application No.', invoiceNo: 'Fiscal Invoice No.',
    contract: 'Contract', customer: 'Customer', owner: 'Owner', handler: 'Handler', direction: 'Direction',
    directionBlue: 'Blue Invoice', directionRed: 'Credit Invoice', status: 'Status', statusDraft: 'Draft',
    statusIssued: 'Issued', statusPartiallyRed: 'Partially Credited', statusFullyRed: 'Fully Credited',
    statusVoided: 'Voided', type: 'Invoice Type', typeOrdinary: 'VAT Ordinary Invoice',
    typeSpecial: 'VAT Special Invoice', amount: 'Invoice Amount', redAmount: 'Credited Amount',
    invoiceDate: 'Invoice Date', originalInvoice: 'Original Invoice', title: 'Buyer Name', taxNo: 'Tax No.',
    registeredAddress: 'Registered Address', registeredPhone: 'Registered Phone', bankName: 'Bank Name',
    bankAccount: 'Bank Account', email: 'Delivery Email', content: 'Invoice Content', remark: 'Draft Note',
    issueRemark: 'Issue Note', provider: 'Invoice Provider', providerRequest: 'Provider Request ID',
    createDraft: 'Create Invoice Draft', updateDraft: 'Update Invoice Draft', issue: 'Issue',
    redFlush: 'Credit', void: 'Void', redInvoiceNo: 'Credit Invoice No.', redAmountForm: 'Credit Amount',
    redReason: 'Credit Reason', voidReason: 'Void Reason', remainingRedAmount: 'Remaining Credit Amount',
    contractAmount: 'Contract Amount', blueAmount: 'Effective Blue Amount', netAmount: 'Net Invoiced',
    availableAmount: 'Available Amount', snapshotHint: 'Contract, customer and owner are inherited from the approved contract. Issued invoice data is immutable.',
    issueImmutableHint: 'This action creates a formal ledger entry. Verify the fiscal number, date and buyer information.',
    voidHint: 'A voided invoice is excluded from effective invoice totals. A blue invoice with active credits cannot be voided.',
    confirmIssue: 'Confirm Issue', confirmRedFlush: 'Confirm Credit', confirmVoid: 'Confirm Void',
    issueSuccess: 'Invoice issued', redFlushSuccess: 'Credit invoice created', voidSuccess: 'Invoice voided',
    actionRecords: 'Lifecycle History', noActionRecords: 'No lifecycle history',
    actionCreate: 'Draft Created', actionUpdate: 'Draft Updated', actionIssue: 'Issued',
    actionVoid: 'Blue Invoice Voided', actionRedFlush: 'Credited', actionVoidRed: 'Credit Invoice Voided', actionDelete: 'Draft Deleted',
    contractRequired: 'Contract is required', handlerRequired: 'Handler is required', typeRequired: 'Invoice type is required',
    amountRequired: 'Invoice amount is required', titleRequired: 'Buyer name is required', contentRequired: 'Invoice content is required',
    specialInfoRequired: 'Complete buyer tax details are required for a VAT special invoice', emailInvalid: 'Invalid email address',
    invoiceNoRequired: 'Fiscal invoice number is required', invoiceDateRequired: 'Invoice date is required',
    redReasonRequired: 'Credit reason is required', voidReasonRequired: 'Void reason is required', exportFileName: 'CRM Invoices'
  },
  receivable: {
