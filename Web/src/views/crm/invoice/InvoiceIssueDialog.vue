...
type InvoiceIssueForm = Omit<InvoiceApi.InvoiceIssueReqVO, 'invoiceDate'> & {
...
const submit = async () => {
  ...
  try {
    ...
    message.success(t('invoice.issueSuccess'))
    visible.value = false
    emit('success')
  } finally {
    loading.value = false
